...
class CourseTypesControllerTest < ActionController::TestCase
  ...
  test "should create course_type" do
    assert_difference('CourseType.count') do
      post :create, course_type: { active: @course_type.active, description: @course_type.description, name: @course_type.name, slug: @course_type.slug }
    end
  ...
  test "should update course_type" do
    patch :update, id: @course_type, course_type: { active: @course_type.active, description: @course_type.description, name: @course_type.name, slug: @course_type.slug }
    assert_redirected_to course_type_path(assigns(:course_type))
  end
